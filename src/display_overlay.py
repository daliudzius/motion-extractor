...
class DisplayOverlay:
    ...
    def __init__(self, font_scale: float = 0.6, font_thickness: int = 2, bg_opacity: float = 0.7):
        """
    ...
    def render_bottom_info(
        self, frame: np.ndarray, delay_text: str, camera_name: str = ""
    ) -> np.ndarray:
        """
